...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 06, 2022 at 07:22 AM
...
INSERT INTO `articles` (`id`, `head`, `body`, `date`) VALUES
...
(9, 'nerve dedicate back start actually start yarn sleep ', 'kill shrill airport therapeutic memory note therapeutic economic start actually caption psychedelic jittery start note listen found stem stem shirt sleep airplane psychedelic zinc yarn found kill airport sleep kill stem nerve fireman economic back nerve shrill jittery psychedelic shirt ', '2022-06-26'),
...
(77, 'yarn nerve sleep yield eight kill shrill psychedelic ', 'shirt yarn structure economic hide back jittery stem structure rambunctious humiliate pathetic psychedelic pathetic yarn note back actually pathetic shirt jittery nerve sleep caption airplane caption rambunctious airplane airport actually pathetic shrill stem actually listen yield eight actually yield rambunctious ', '2022-06-25'),
...
(86, 'fireman sleep memory stem pathetic found economic stem ', 'shrill structure eight economic dedicate airplane airport found found kill zinc sleep rambunctious humiliate memory fireman back kill structure opine bed listen back sleep psychedelic back psychedelic zinc opine caption airplane zinc hide caption jittery sleep airplane note opine stem ', '0000-00-00'),
(87, 'shrill rambunctious stem shrill yarn psychedelic hide dedicate ', 'sleep therapeutic sleep shirt psychedelic zinc melodic found eight humiliate shirt caption eight therapeutic hide melodic jittery airplane memory humiliate found yarn airport sleep yarn sleep nerve jittery fireman sleep economic shirt jittery found humiliate yarn airport rambunctious listen economic ', '2022-05-07'),
(88, 'caption hide listen pathetic therapeutic nerve shrill caption ', 'yarn humiliate hide hide yield dedicate actually psychedelic airport bed economic eight dedicate pathetic rambunctious stem stem economic shrill melodic humiliate yield opine actually shrill eight note opine shrill economic kill start back note yarn pathetic yield eight yarn shirt ', '2022-06-02'),
(89, 'memory dedicate yield nerve yarn psychedelic melodic yield ', 'fireman note nerve actually structure eight note note airplane memory caption rambunctious structure actually opine therapeutic shirt found start shrill humiliate yarn humiliate memory shrill dedicate yield airplane bed hide hide sleep actually hide actually dedicate yield listen start airplane ', '2022-05-17'),
(90, 'airplane shrill psychedelic eight shrill bed memory shrill ', 'back therapeutic bed psychedelic caption hide economic note note kill airplane humiliate kill sleep memory therapeutic shrill stem listen sleep shrill airplane airport airplane airplane jittery airport start actually found hide shrill memory eight jittery therapeutic zinc zinc shrill bed ', '0000-00-00');
